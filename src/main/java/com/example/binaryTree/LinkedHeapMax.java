 ...
 * @author Micael
 */
public class LinkedHeapMax<T extends Comparable<? super T>> extends LinkedBinaryTree<T> implements HeapMaxADT<T> {

    private HeapNode<T> lastNode;

    public LinkedHeapMax() {
        super();
        this.lastNode = null;
    }

    public LinkedHeapMax(T element) {
        super(element);
        this.lastNode = null;
    }
